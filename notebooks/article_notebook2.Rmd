...
print(paste0("Broiler median distance: ",
             round(median(cophenetic.phylo(cgMLST_tree_broiler)), 2)))

print(paste0("Pig median distance: ",
             round(median(cophenetic.phylo(cgMLST_tree_pig)), 2)))

print(paste0("Red fox median distance: ",
             round(median(cophenetic.phylo(cgMLST_tree_fox)), 2)))

print(paste0("Wild bird median distance: ",
             round(median(cophenetic.phylo(cgMLST_tree_bird)), 2)))

par(mfrow = c(2,2))

hist(cophenetic.phylo(cgMLST_tree_broiler),
     breaks = 20,
     main = "Broiler distance frequency",
     xlab = "Distance",
     ylim = c(0,6000))

hist(cophenetic.phylo(cgMLST_tree_pig),
     breaks = 20,
     main = "Pig distance frequency",
     xlab = "Distance",
     ylim = c(0,6000))

hist(cophenetic.phylo(cgMLST_tree_fox),
     breaks = 20,
     main = "Red fox distance frequency",
     xlab = "Distance",
     ylim = c(0,6000))

hist(cophenetic.phylo(cgMLST_tree_bird),
     breaks = 20,
