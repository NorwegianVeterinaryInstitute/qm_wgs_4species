...
- Land on methodology for phylogenetic analysis (likely core genome SNP - ML)
...
mut_genes <- c("gyr","par","marR","marA","acrB","soxR","acrR","nor","ydh","mdf","sdi","rpoB")
...
acquired_report %>%
  ...
  left_join(mut_report[c("id","marR","marA","mdfA","acrB","rpoB")], by = "id") %>%
