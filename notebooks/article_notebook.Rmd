...
# 
# ## heatmap
# heatmap_st <- ggplot(st_heatmap_df, aes(mechanism, factor(ST), fill = percent))+
#   geom_tile()+
#   scale_fill_viridis(option = "A")+
#   guides(fill = FALSE)+
...
# 
# ## micplot
# micplot_st <- ggplot(micplot_st_df, aes(factor(ST), CIP))+
...
# 
# # n plot
# nplot_st <- ggplot(species_st, aes(factor(ST), n, fill = species))+
#   geom_col(color = "black")+
#   scale_fill_manual(values = palette) +
#   theme(axis.title = element_blank(),
#         axis.text.y = element_blank(),
