...
gheatmap(p,
  ...
  annotate("label", x = 0.27, y = 270, label = "Clade A") +
  annotate("label", x = 0.29, y = 251, label = "Clade B") +
  annotate("label", x = 0.39, y = 167, label = "Clade C") +
  annotate("label", x = 0.38, y = 138, label = "Clade D") +
  annotate("label", x = 0.32, y = 57, label = "Clade E") +
  annotate("label", x = 0.31, y = 31, label = "Clade F")
...
names(dist_data) <- c("Clade D", "Clade F", "Clade A", "Clade E", "Clade B", "Clade C")
...
names(raw_trees) <- c("Clade D","Clade E","Clade B","Clade C")
