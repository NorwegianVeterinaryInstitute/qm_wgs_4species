...
```{r}
p1 <- ggplot(metrics2, aes(species, N50)) +
...
p2 <- ggplot(metrics2, aes(species, no_of_contigs)) +
  stat_boxplot(geom = "errorbar", width = 0.4) +
  geom_boxplot() +
...
p3 <- ggplot(metrics2, aes(species, largest_contig)) +
  stat_boxplot(geom = "errorbar", width = 0.4) +
  geom_boxplot() +
...
p4 <- ggplot(metrics2, aes(species, as.numeric(no_of_misassemblies))) +
  stat_boxplot(geom = "errorbar", width = 0.4) +
  geom_boxplot() +
...
```{r}
p5 <- ggplot(metrics2, aes(sequencer, N50)) +
  stat_boxplot(geom = "errorbar", width = 0.4) +
  geom_boxplot() +
  scale_y_continuous(labels = comma) +
  theme(axis.title.x = element_blank(),
...
p6 <- ggplot(metrics2, aes(sequencer, no_of_contigs)) +
  stat_boxplot(geom = "errorbar", width = 0.4) +
  geom_boxplot() +
  labs(y = "No. of contigs") +
  theme(axis.title.x = element_blank(),
...
p7 <- ggplot(metrics2, aes(sequencer, largest_contig)) +
  stat_boxplot(geom = "errorbar", width = 0.4) +
  geom_boxplot() +
  labs(y = "Largest contig") +
  scale_y_continuous(labels = comma) +
...
p8 <- ggplot(metrics2, aes(sequencer, as.numeric(no_of_misassemblies))) +
  stat_boxplot(geom = "errorbar", width = 0.4) +
  geom_boxplot() +
  labs(y = "No. of misassemblies") +
  scale_y_continuous(labels = comma) +
